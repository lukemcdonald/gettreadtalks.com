...
const button = classNames(buttonStyle, 'text-gray-700 bg-gray-200 hover:bg-opacity-80')

const dangerButton = classNames(buttonStyle, 'text-primary-700 bg-primary-100 hover:bg-primary-200')
